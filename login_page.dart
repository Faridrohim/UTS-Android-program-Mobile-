...
class _LoginPageState extends State<LoginPage> {
    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [Color.fromARGB(255, 209, 215, 120), Colors.grey],
        ),
      ),
      child: Scaffold(
 ...
 Widget _icon() {
    ...
    return ElevatedButton(
      onPressed: () {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  const DashboardScreen()), // Gantilah 'DashboardScreen()' dengan nama halaman dashboard yang sebenarnya
        );
      },
  ...
  Widget _extraText() {
    return const Text(
      "FARID ABDUL ROHIM (21670008)",
      textAlign: TextAlign.center,
      style: TextStyle(fontSize: 20, color: Color.fromARGB(255, 21, 0, 255)),
    );
  }
}
